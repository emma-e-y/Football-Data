...
# =====================================================
print("\n=== Titans Off Success Rate (%): 2023 vs 2024 ===")
...
for xi, yi in zip(x, y):
    plt.text(xi, yi + offset, f"{yi:.2f}", ha="center", va="bottom", fontsize=10)

plt.title("Titans Offensive Success Rate: 2023 vs 2024", fontsize=16, weight="bold")
plt.ylabel("Offensive Success Rate (%)", fontsize=14)
plt.xticks(x, ["2023", "2024"])

poop_legend(plt.gca())

plt.tight_layout()
outpath = os.path.join(OUTDIR, "bar_off_success_23vs24_final.png")
