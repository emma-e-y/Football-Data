...
# =====================================================
print("\n=== Titans Points Against: 2023 vs 2024 ===")
...
plt.title("Titans Points Against: 2023 vs 2024", fontsize=16, weight="bold")
...
plt.tight_layout()
outpath = os.path.join(OUTDIR, "bar_pa_23vs24_final.png")
