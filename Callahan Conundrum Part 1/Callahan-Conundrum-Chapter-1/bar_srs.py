...
plt.title("Titans Simple Rating System (SRS): 2023 vs 2024", fontsize=16, weight="bold")
...
plt.tight_layout()
outpath = os.path.join(OUTDIR, "bar_srs_23vs24_final.png")
