...
plt.title("Titans Defensive Expected Points Added: 2023 vs 2024", fontsize=16, weight="bold")
plt.ylabel("Defensive EPA", fontsize=14)
plt.xticks(x, ["2023", "2024"])

poop_legend(plt.gca())

plt.tight_layout()
outpath = os.path.join(OUTDIR, "bar_def_epa_23vs24_final.png")
