...
plt.title("Titans Offensive Simple Rating System (OSRS): 2023 vs 2024", fontsize=16, weight="bold")
plt.ylabel("OSRS", fontsize=14)
plt.xticks(x, ["2023", "2024"])

poop_legend(plt.gca())

plt.tight_layout()
outpath = os.path.join(OUTDIR, "bar_osrs_23vs24_final.png")
