...
# =====================================================
print("\n=== Titans Off Early EPA: 2023 vs 2024 ===")
...
for xi, yi in zip(x, y):
    plt.text(xi, yi + offset, f"{yi:.3f}", ha="center", va="top", fontsize=10)

plt.title("Titans Offensive Early-Down  EPA: 2023 vs 2024", fontsize=16, weight="bold")
plt.ylabel("Offensive Early EPA", fontsize=14)
plt.xticks(x, ["2023", "2024"])

poop_legend(plt.gca())

plt.tight_layout()
outpath = os.path.join(OUTDIR, "bar_off_early_epa_23vs24_final.png")
