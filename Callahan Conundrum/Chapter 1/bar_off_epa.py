...
plt.title("Titans Offensive Expected Points Added: 2023 vs 2024", fontsize=16, weight="bold")
plt.ylabel("Offensive EPA", fontsize=14)
plt.xticks(x, ["2023", "2024"])

poop_legend(plt.gca())

plt.tight_layout()
outpath = os.path.join(OUTDIR, "bar_off_epa_23vs24_final.png")
