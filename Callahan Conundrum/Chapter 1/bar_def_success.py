...
# =====================================================
print("\n=== Titans Def Success Rate (%): 2023 vs 2024 ===")
...
plt.title("Titans Defensive Success Rate: 2023 vs 2024", fontsize=16, weight="bold")
...
plt.tight_layout()
outpath = os.path.join(OUTDIR, "bar_def_success_23vs24_final.png")
