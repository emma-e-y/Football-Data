...
# =====================================================
print("\n=== Titans Point Differential: 2023 vs 2024 ===")
...
plt.title("Titans Point Differential: 2023 vs 2024", fontsize=16, weight="bold")
plt.ylabel("PD", fontsize=14)
plt.xticks(x, ["2023", "2024"])

poop_legend(plt.gca())

plt.tight_layout()
outpath = os.path.join(OUTDIR, "bar_pd_23vs24_final.png")
