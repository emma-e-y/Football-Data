...
# =====================================================
df["rolling_3"] = (
    df.groupby("season")["def_epa_game"]
      .rolling(3)
      .mean()
...
# SANITY CHECK PRINT
# =====================================================
print("\n=== Titans Defensive EPA (Game-Level + 3-Game Rolling) ===\n")
...
for season in [2023, 2024]:
    ...
    for _, row in s.iterrows():
        ...
        print(
            ...
            f"Game EPA = {row['def_epa_game']:.4f}, "
            f"Rolling 3 = {rolling}"
        )
...
# =====================================================
plt.tight_layout()
outpath = os.path.join(OUTDIR, "line_def_epa_by_game_final.png")
