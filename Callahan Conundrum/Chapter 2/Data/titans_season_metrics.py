...
OUT_SEASON = "titans_season_metrics.csv"
...
for year in YEARS:
    ...
    # PROE
    # --------------------
    actual_pass_rate = ten_off["pass"].mean() * 100
    expected_pass_rate = pbp["pass"].mean() * 100
    season_df["proe_pct_points"] = actual_pass_rate - expected_pass_rate
